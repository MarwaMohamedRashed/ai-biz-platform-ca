        ...
        <div className="hidden md:flex md:w-[42%] md:flex-shrink-0 flex-col justify-between
          ...
          <div className="relative z-10">
            <h2 className="text-[28px] font-extrabold text-white leading-tight tracking-tight mb-4">
              {t('brandHeadline1')}<br/>
              <span className="text-[#f97316]">{t('brandHeadline2')}</span>
            </h2>
            <p className="text-sm text-white/75 leading-relaxed mb-7">
              {t('brandDescription')}
            </p>
            <ul className="flex flex-col gap-2.5">
              {(['brandFeature1', 'brandFeature2', 'brandFeature3', 'brandFeature4'] as const).map((key) => (
                <li key={key} className="flex items-center gap-2.5 text-[13px] text-white/85 font-medium">
            ...
            <div className="w-full max-w-sm md:max-w-[440px]
              ...
              <div className="px-6 pb-9 md:px-0 md:pb-0 md:w-full">
                ...
                <div className="inline-flex items-center gap-1.5 bg-green-50 border border-green-200
                                rounded-full px-3 py-1 text-xs font-semibold text-green-700 mb-5">
                  🎉 {t('trialBadge')}
                </div>
                ...
                <GoogleAuthButton translationKey="signupWithGoogle" />

                <div className="flex items-center gap-3 mb-5">
                  <div className="flex-1 h-px bg-slate-200" />
                  <span className="text-xs text-slate-400 font-medium">{t('orUseEmail')}</span>
                  <div className="flex-1 h-px bg-slate-200" />
                </div>
